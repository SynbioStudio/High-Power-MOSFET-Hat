...
pin0 = mcp.get_pin(0) #create an instance of the pin you wish to address. You can set the number within parentheses from 0 to 3 to select a MOSFET on the hat.
